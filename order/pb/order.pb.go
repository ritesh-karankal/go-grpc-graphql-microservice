...
func (x *GerOrderRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GerOrderRequest) ProtoMessage() {}

func (x *GerOrderRequest) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GerOrderRequest.ProtoReflect.Descriptor instead.
func (*GerOrderRequest) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{3}
}

func (x *GerOrderRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_order_proto_rawDesc = "" +
	...
	"\x13GetOrdersForAccount\x12\x1e.pb.GetOrdersForAccountRequest\x1a\x1f.pb.GetOrdersForAccountResponse\"\x00B=Z;github.com/ritesh-karankal/go-grpc-graphql-micro/catalog/pbb\x06proto3"
...
var file_order_proto_goTypes = []any{
	...
	(*GerOrderRequest)(nil),               // 3: pb.GerOrderRequest
