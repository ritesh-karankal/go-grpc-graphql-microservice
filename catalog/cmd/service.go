...
type Service interface {
	...
	GetProduct(ctx context.Context, id string) (*Product, err)
...
func (s *catalogService) PostProuct(ctx context.Context, name, description string, price float64) (*Product, error) {
	p := &Product{
		Name:        name,
