...
type Repository interface {
	...
	SearchProducts(ctx context.Context, query string, skip uint64, take uint64)
}
...
func (r *elasticRepository) SearchProducts(ctx context.Context, query string, skip uint64, take uint64) {
	res, err := r.client.Search().
		Index("catalog").
		Type("Product").
