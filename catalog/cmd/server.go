...
func (s *grpcServer) PostProduct(ctx context.Context, r *pb.PostProduct) {
...
func (s *grpcServer) GetProduct(ctx context.Context, r *pb.PostProduct) {
...
func (s *grpcServer) GetProducts(ctx context.Context, r *pb.PostProduct) {
	var res []Product
	var err error
	if r.Query != "" {
